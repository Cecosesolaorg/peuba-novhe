            ...
            groups.forEach(group => {
                ...
                group.items.forEach((item, index) => {
                    ...
                    item.registros.forEach((log, index) => {
                        ...
                        detailedBreakdownHtml += `<div class="${bgColor} text-white px-1 py-1 rounded text-[11px] font-bold shadow-sm text-center truncate" title="${piecePrefix}${singleKg} (${singleAbbr})">${piecePrefix}${singleKg} (${singleAbbr})</div>`;
                    });
